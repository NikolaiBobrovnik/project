...
import css from './brandZoneMap.scss'
...
import SuggestView from './SuggestView/SuggestView'
...
export default class BrandZoneMap extends Component {
  ...
  render () {
    const { mapState, currentZone, userLocation } = this.props.brandZoneState
      ...
      <div className={css.wrapper}>
        ...
        <div className={css.in}>
          <ScrollArea {...{
            ...
            {currentZone ? this.renderBrandZoneCard() : this.renderBrandZoneList()}
          </ScrollArea>
